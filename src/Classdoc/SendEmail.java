...
public class SendEmail {
    ...
    public SendEmail(String mailTo, String subject, String message) throws Exception
    {
        String mailFrom="tourstravels2019@gmail.com";
        
        String password="Neeraj@truba";
...
/*
    SendEmail(String mailFrom, String password, String mailTo, String subject, String message, String[] attachFiles) throws Exception
    {
        if (mailFrom.contains("@gmail"))
            this.host = "smtp.gmail.com";
        else if (mailFrom.contains("@yahoo"))
